...
namespace csl {
	...
	assert( offset < header_.sizeOfAnnStrings_ );
    ...
    inline void MinDicString::loadFromFile( FILE* fi ) {
	...
	annHash_ = new Hash< uchar >( estimatedNrOfKeys, annStrings_, header_.sizeOfAnnStrings_ );
