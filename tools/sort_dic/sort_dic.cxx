...
int main( int argc, char** argv ) {
	...
	std::wcerr<<"sortLex - sort .lex dictionary source files to be compiled into a FSA."<<std::endl
		  <<"Easier and faster is the unix sort tool: $> LC_ALL=C sort -t'#' -k1,1 foo.lex"<<std::endl;
	return 1;
    }
    else std::wcerr<<"Easier and faster is the unix sort tool: $> LC_ALL=C sort -t'#' -k1,1 foo.lex"<<std::endl;
